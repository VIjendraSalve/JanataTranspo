        ...
        try {
            ...
            try {
                ...
                if (cursor.moveToFirst()) {
                    do {
                        Notification obj = new Notification(cursor.getString(0),cursor.getString(1),cursor.getString(2),cursor.getString(3),formatedDate.formatToYesterdayOrToday(cursor.getString(4)));
