...
public class Notification
{
    ...
    public Notification(String notification_id, String notification_title, String notification_message, String notification_image,
                        String notification_date_time, String notification_link) {
